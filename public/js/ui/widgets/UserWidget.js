/**
 * Класс UserWidget отвечает за отображение информации
 * о имени пользователя после авторизации или его выхода
 * из системы.
 * */
...
class UserWidget {
  ...
  /**
   * Получает информацию о текущем пользователе с помощью
